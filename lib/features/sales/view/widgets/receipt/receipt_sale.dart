...
class SaleReceipt extends StatefulWidget {
  const SaleReceipt({super.key, required this.entity});

  final ReceiptSaleEntity entity;

  @override
  // ignore: library_private_types_in_public_api
  _SaleReceiptState createState() => _SaleReceiptState();
}
          ...
          children: [
                ...
                widget.entity.vehicle != null
                    ? Row(children: [
                        ...
                        SizedBox(
                            ...
                            child: Text(
                              widget.entity.vehicle?.nickname ?? "",
            ...
            Column(
              ...
              children: [
                ...
                widget.entity.discount != null &&
                        widget.entity.discount!.price > 0
                    ? Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              'Desconto de ${widget.entity.discount?.priceInReal ?? "R\$ 0,00"}',
                              textAlign: TextAlign.center,
                            ).caption1_regular(
                                style: const TextStyle(
                                    color: AppColor.textSecondaryColor)),
                    ...
                    : const SizedBox.shrink(),
                widget.entity.subTotal != null &&
                        widget.entity.subTotal?.price !=
                            widget.entity.total.price
                    ? Padding(
                        padding: const EdgeInsets.only(top: 2),
                        child: Row(
                          children: [
                            ...
                            Text(
                              'Sub-total de ${widget.entity.subTotal?.priceInReal ?? "R\$ 0,00"}',
                              textAlign: TextAlign.center,
                            ).caption1_regular(
                                style: const TextStyle(
                                    color: AppColor.textSecondaryColor)),
                ...
                Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          'Total de ${widget.entity.total.priceInReal}',
                          textAlign: TextAlign.center,
                        ).caption1_bold(
                            style: const TextStyle(
                                color: AppColor.textSecondaryColor)),
